...
class DenseLayer(FullyConnectedLayer):
    ...
    def feedforward(self, X):
        ...
        ################################################
        W,b=self.params
        self.X=X #Updation with input
        A=affine_forward(X,W,b) 
        self.A=A # Updating with affine output (cache)
        out=relu_forward(A) 
        ################################################
        #              END OF YOUR CODE                #
        ################################################
    ...
    def backward(self, dout):
        ...
        #layer_funcs.py                                #
        ################################################
        temp=relu_backward(dout,A) 
        dX,dW,db=affine_backward(temp,X,W,b) 
        ################################################
        #              END OF YOUR CODE                #
        ################################################
...
class AffineLayer(FullyConnectedLayer):
    ...
    def backward(self, dout):
        ...
        #layer_funcs.py                                #
        ################################################
        dX,dW,db=affine_backward(dout,X,W,b) #Backprop of Affine
